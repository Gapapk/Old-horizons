...
*Спомощью файла **Old Horizons.ccode** вы можете изменить SP под свой стиль,а также изучить исходный код для своих проектов. 
Его можно открыть через CCode билд 1387.(https://play.google.com/store/apps/details?id=com.ganin.ccode)*
