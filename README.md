...
*Если вам нужно скачать примеры кодов то делайте тоже самое но дальше заходите в пред. Главное меню/Консоль и выбираете режим который вам нужен и импортируйте код.*
...
``Игра ещё в бете и могут быть баги в следующих обновлениях будут баг-фиксы.``
